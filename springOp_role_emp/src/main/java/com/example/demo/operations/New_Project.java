...
public class New_Project {
	...
	String newprojectOp(EmpPojo new_project_obj) {
		// new project name
...
//		String hr_user_name="", prject_manager_uname="";
				...
				for(Map emp_table_obj : emp_table) {
					...
					if(role==true && current_login_user_name==true && current_login_user_name== true) {
						...
						System.out.println("validated old_project table executed");
...
//									System.out.println(start_date+" "+end_date);
									...
									if(project_table != 0) {
										...
										result = "successfully copy the with the Project Details into new Project";
										break;
									}else {
	...
	String copy_emp_to_new_project(EmpPojo copy_project_obj, String oldproject_name, String newproject_name, String new_project_id ) {
